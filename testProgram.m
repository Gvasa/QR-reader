function [] = testProgram(correctBygg, correctHus, dos)
    ...
    assignin('base', 'var', procent);

procentHus = zeros(1,25);


img=imread('pictures/Hus_1.png');    % Bra ib?rjan, en till punkt
procentHus(1,1) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 1');
img=imread('pictures/Hus_1a.png'); 
procentHus(1,2) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 1a');
img=imread('pictures/Hus_1b.png'); 
procentHus(1,3) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 1b');
img=imread('pictures/Hus_1c.png'); 
procentHus(1,4) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 1c');
img=imread('pictures/Hus_1d.png'); 
procentHus(1,5) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 1d');
img=imread('pictures/Hus_1e.png'); 
procentHus(1,6) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 1e');
img=imread('pictures/Hus_2.png'); 
procentHus(1,7) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 2');
img=imread('pictures/Hus_2a.png'); 
procentHus(1,8) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 2a');
img=imread('pictures/Hus_2b.png'); 
procentHus(1,9) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 2b');
img=imread('pictures/Hus_2c.png'); 
procentHus(1,10) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 2c');
img=imread('pictures/Hus_2d.png'); 
procentHus(1,11) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 2d');
img=imread('pictures/Hus_2e.png'); 
procentHus(1,12) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 2e');
img=imread('pictures/Hus_3.png'); 
procentHus(1,13) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 3');
img=imread('pictures/Hus_3a.png');
procentHus(1,14) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 3a');
img=imread('pictures/Hus_3b.png'); 
procentHus(1,15) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 3b');
img=imread('pictures/Hus_3c.png'); 
procentHus(1,16) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 3c');
img=imread('pictures/Hus_3d.png'); 
procentHus(1,17) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 3d');
img=imread('pictures/Hus_3e.png'); 
procentHus(1,18) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 3e');
img=imread('pictures/Hus_4.png');  
procentHus(1,19) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 4');
img=imread('pictures/Hus_4a.png'); 
procentHus(1,20) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 4a');
img=imread('pictures/Hus_4b.png'); 
procentHus(1,21) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 4b');
img=imread('pictures/Hus_4c.png'); 
procentHus(1,22) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 4c');
img=imread('pictures/Hus_4d.png');
procentHus(1,23) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 4d');
img=imread('pictures/Hus_4e.png');
procentHus(1,24) = 100*(sum(eq(correctHus, tnm034(img)))/182)
disp('klar med hus 4e');
% img=imread('pictures/Husannons_full.png'); %Funker ej
% procentHus(1,25) = 100*(sum(eq(correctHus, tnm034(img)))/182);
% disp('klar med hus husannons_full');
% img=imread('pictures/dos.png'); %Funker ej
% procentHus(1,26) = 100*(sum(eq(dos, tnm034(img)))/182);
% disp('klar med dos');

procentHus
Final = sum(procentHus(:,:))/25;
assignin('base', 'var_hus', procentHus);
...
procentIllum(1,2) = 100*(sum(eq(correctHus, tnm034(img)))/182);
disp('klar med hus 1 Illum');
img=imread('pictures/Hus_4_Illum.png'); 
procentIllum(1,3) = 100*(sum(eq(correctHus, tnm034(img)))/182);
disp('klar med hus 4 Illum');

procentIllum
Final = sum(procentIllum(:,:))/3

assignin('base', 'var_illum', procentIllum);
